...
const DEFAULT_SITE_ID = "site_franchisor_id";
...
async function callDeployHook() {
  const url = process.env.PAGES_DEPLOY_HOOK_FRANCHISOR_ID;
  if (!url) {
    throw new Error("Missing PAGES_DEPLOY_HOOK_FRANCHISOR_ID secret containing the full Cloudflare Pages Deploy Hook URL.");
  }
