...
**Re-review after `27a783c`:** [The follow-up review](ROLLOUT_CODE_REVIEW_2026-09-26.md) records a passing disposable published-row build for a new `/usaha/{slug}` page, directory card, canonical, and legacy preservation. Deployment and signed-in checks remain open; profile-review approval, account-to-public-contact coupling, orphan claim profiles, and staff exposure of claimant data need the bounded repairs documented there in **both** repositories.
