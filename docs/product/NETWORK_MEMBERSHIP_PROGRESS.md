...
| D.2b | Pin the published-brand build proof: a published new slug, unpublished slug, and published existing legacy slug must prove route precedence and directory/detail/canonical/sitemap agreement | Gate 4 | Franchisor.id | ⚠️ partial | Reviewer hand-ran one new published slug successfully; no repeatable fixture, unpublished-row assertion, or existing-slug collision proof yet. See [handoff §3](../operations/ASTRO_CLOUDFLARE_BRAND_PUBLISH_PLAN.md). | 2026-09-26 |
