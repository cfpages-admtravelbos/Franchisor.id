...
function basePage(options: { title: string; description: string; canonicalPath: string; bodyClass: string; body: string }) {
  const title = `${options.title} | Franchisor.id`;
  return `<!doctype html>
<html lang="id">
  <head>
    <meta charset="UTF-8">
    ...
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700;800;900&family=Lexend:wght@600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="/css/franchise-buyer-tools.css">
    <link rel="stylesheet" href="/css/franchisor-theme.css">
  </head>
  <body class="${escapeAttr(options.bodyClass)}">
    <header class="fr-tool-header">
      <a class="fr-tool-brand" href="/"><img src="/wp-content/uploads/2025/10/fr-logo-website-franchisor.id_.png" alt="Franchisor.id"></a>
