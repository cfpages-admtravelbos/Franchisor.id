/**
 * /js/form-utils.js
 * Shared utilities adapted for Franchisor.id forms.
 */
...
window.whatsappDigitRangeForField = function(field, digits) {
    ...
    const FF = window.FranchiseForm || {};
    const selectedRange = typeof FF.whatsappDigitRangeForDialCode === 'function'
        ? FF.whatsappDigitRangeForDialCode('+' + countryCode)
        : [8, 13];
