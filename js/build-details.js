...
function generateJSONLD(item, slug) {
    const schema = {
        ...
        "url": `https://franchisor.id/peluang-usaha/${slug}`,
        "logo": item.logo_url || "https://franchisor.id/wp-content/uploads/2025/10/cropped-fr-logo-website-franchisor.png",
    ...
    try {
        ...
        for (const item of allData) {
            ...
            const replacements = {
                ...
                '{SEO_DESCRIPTION}': `Cek modal dan biaya franchise ${item.brand_name}. Dapatkan profil lengkap, syarat jadi mitra, dan kontak resmi franchisor ${item.brand_name} di Franchisor.id.`,
