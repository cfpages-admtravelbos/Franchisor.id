  ...
  function createProfileRenderer(state, helpers) {
    ...
    function membershipPanel() {
      ...
      return `
        ...
        <p class="fr-profile-copy">Aktifkan Premium Network agar listing brand tampil lebih lengkap di jaringan Franchisor.id.</p>
      ...
      return `
        <div class="fr-profile-premium-grid">
          <div class="fr-profile-premium-benefits">
            <h3>Yang didapat</h3>
            <ul>
              <li><i class="fas fa-network-wired" aria-hidden="true"></i> Distribusi ke jaringan Franchisor.id</li>
